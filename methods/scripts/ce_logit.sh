#!/usr/bin/env bash
# GPT-2 CE logit-steering Token Presence via runner.py.
set -euo pipefail
...
MODEL_ID="gpt2"
PROPOSAL_TYPE="CE_LOGIT"
EVENT_TYPE="token"
EVENT_CONFIG_JSON='{"surrogate":"sum"}'
OUTPUT_PATH="${OUTPUT_PATH:-${METHODS_DIR}/../runs/ce_logit_token}"
