...
def load_trainable_components(
    ...
    # Eval-only reuse: load the proposal from a saved trained_model dir when
    # provided, otherwise from the base --model_id. The reference model is
    # unaffected (it always uses resolve_model_source -> --model_id).
